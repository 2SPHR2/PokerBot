...
class Thread {
  ...
  async close(suppressSystemMessage = false, silent = false) {
    if (! suppressSystemMessage) {
      ...
      if (silent) {
        await this.postSystemMessage(':gear:**System: **Darhaal Bastan Makhfianeh Ticket...');
      } else {
        await this.postSystemMessage(':gear:**System: **Darhaal Bastan Ticket...');
      }
    }
    ...
    if (channel) {
      ...
      await channel.delete(':gear:**System: **Ticket Baste Shod');
    }
  }
